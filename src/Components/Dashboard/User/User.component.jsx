...
const UserComponent = ({ user_credentials }) => {
  ...
  //       onClick={() => GetUserDetails(data?._id)}
  //       style={{ color: "#808080" }}
  //       className="flex  capitalize hidden cursor-pointer border-b-2 py-5 text-md font-bold font-manrope my-2 md:my-5 items-center justify-between"
  //     >
