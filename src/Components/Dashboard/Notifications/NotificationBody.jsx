  ...
  const renderNotifications = notifications?.docs?.map((data, index) => {
    return (
      <section
        ...
        style={{ color: " #2E303D" }}
        className="grid cursor-pointer notification-grid-content border-b-2 md:py-3 py-2 gap-5 md:text-base my-4 text-sm pb-3"
    ...
    <>
      <main>
        ...
        >
          ...
          <h2 className="shrink-0">Date & Time</h2>
          <h2 className="shrink-0 md:py-0   text-center">Sender</h2>
